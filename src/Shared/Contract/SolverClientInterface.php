...
interface SolverClientInterface
{
     ...
     *
     * Запрос проходит через Playwright fetch() с правильным TLS fingerprint
     ...
     * @param string $url Полный URL для запроса
     * @param string|null $proxy Прокси-сервер
     * @return array{html: string, session: \App\Shared\DTO\SessionData|null}|null Сырой HTML + сессия или null при ошибке
     */
